...
class Controller(object):
    ...
    def control(self, current_vel, dbw_enabled, linear_vel, angular_vel):
        ...
        #angular_vel = self.angular_vel_lpf.filt(angular_vel)
        
        #rospy.logwarn("Angular vel: {0}\n".format(angular_vel))
        ...
        if linear_vel == 0. and current_vel < 0.1:
            throttle = 0
            brake = 700 # N*m - to hold thecar in place if we are stopped at a light. Acceleration ~ 1m/(s*s)
